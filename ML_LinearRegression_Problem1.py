...
####  learning rate = 0.009  and  Threshold = 0.001   ###################################
...
sr = float( input("Enter split ratio i.e (no. of trainee set / no. of testing set) ratio: "))
...
theta, current_loss, CostFunction, Iteration = LinearRegression( x_train, y_train, alpha)
